...
const allowedImageOwners = new Set([
  ...
  'packages/ui/src/components/ImageCropper.svelte',
  'packages/ui/src/components/MediaLibraryModal.svelte',
  'packages/ui/src/components/PresenceAvatarGroup.svelte',
  'packages/lite/src/components/LiteMediaThumbnail.svelte',
  'packages/lite/src/components/LiteCanvasAnnotation.svelte',
  'packages/lite/src/components/LiteImageCropper.svelte',
  'packages/lite/src/components/LiteSignaturePad.svelte',
...
const fixedFormatOwners = new Set([
  ...
  'packages/ui/src/components/SplitPaneLayout.svelte',
  'packages/ui/src/components/MasterDetailView.svelte',
  'packages/ui/src/components/MediaLibraryModal.svelte',
  'packages/ui/src/components/PdfDocumentViewer.svelte',
  'packages/ui/src/components/StepForm.svelte',
  ...
  'packages/lite/src/components/LiteSplitPaneLayout.svelte',
  'packages/lite/src/components/LiteMasterDetailView.svelte',
