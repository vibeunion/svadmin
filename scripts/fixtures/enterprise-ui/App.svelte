...
<main>
  ...
  <div class="columns">
    <section aria-label="Schema form">
      ...
      <div class="fixture-actions"><button type="button" onclick={() => failNext = true}>Fail next submit</button><button type="button" onclick={() => schema = { properties: { nested: { type: 'object', properties: {} } } }}>Unsupported schema</button><button type="button" onclick={() => schema = scalarSchema}>Restore schema</button></div>
