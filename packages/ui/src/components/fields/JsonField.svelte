...
{:else}
  <div class="svadmin-u-da7c36cd8867">
    ...
    {:else}
      <code class="svadmin-u-359090c2d529 svadmin-u-0e65706bcccd svadmin-u-2ef11f1cb219 svadmin-u-45d828117213 svadmin-u-465609a240a8 svadmin-u-07389a777c1f">{display.preview}</code>
    {/if}
  </div>
{/if}
