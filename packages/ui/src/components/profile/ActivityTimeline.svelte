<script lang="ts">
  ...
  const config: Record<ActivityItem['type'], { icon: Component; tone: string; action: string }> = {
    posted: { icon: MessageSquare, tone: 'svadmin-u-375dc44df6e9 svadmin-u-20aaf08a7ed1', action: i18n.t('publicProfile.activityPosted') },
