...
export const referenceDemoData = {
  ...
  projects: [
    ...
    { id: '5', name: 'Access Review', description: 'Quarterly access certification and role ownership workflow.', status: 'active', members: 4, tasks: 16, progress: 63, tags: ['Security', 'RBAC'] },
    { id: '6', name: 'Billing Portal', description: 'Self-service plans, invoices, and subscription controls.', status: 'active', members: 6, tasks: 27, progress: 58, tags: ['Billing', 'Portal'] },
    { id: '7', name: 'Warehouse Console', description: 'Receiving, transfers, cycle counts, and exception handling.', status: 'completed', members: 9, tasks: 48, progress: 100, tags: ['Inventory', 'Operations'] },
    { id: '8', name: 'Notification Center', description: 'Priority routing, delivery preferences, and read-state controls.', status: 'active', members: 5, tasks: 22, progress: 74, tags: ['Messaging', 'Workflow'] },
    { id: '9', name: 'Partner Directory', description: 'Supplier, customer, and integration partner records.', status: 'active', members: 7, tasks: 31, progress: 46, tags: ['Directory', 'CRM'] },
    { id: '10', name: 'Audit Export', description: 'Scheduled evidence packages for security and compliance review.', status: 'on-hold', members: 3, tasks: 14, progress: 28, tags: ['Audit', 'Export'] },
    { id: '11', name: 'Team Onboarding', description: 'Invitations, import validation, and first-week account setup.', status: 'active', members: 5, tasks: 19, progress: 81, tags: ['People', 'Onboarding'] },
    { id: '12', name: 'AI Prompt Library', description: 'Governed operational prompts with ownership and usage signals.', status: 'completed', members: 4, tasks: 24, progress: 100, tags: ['AI', 'Governance'] },
