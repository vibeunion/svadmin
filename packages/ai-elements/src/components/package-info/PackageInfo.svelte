<script lang="ts">
  ...
  providePackageInfoContext(definedReactiveOptions({ get name() { return name; }, get currentVersion() { return currentVersion; }, get newVersion() { return newVersion; }, get changeType() { return changeType; } }));
</script>
